...
function add_theme_scripts() {   
	...
	wp_enqueue_style( 'risico', get_template_directory_uri() . '/css/risicovol.css');
	wp_enqueue_style( 'vormen', get_template_directory_uri() . '/css/vormen.css');
	wp_enqueue_style( 'tools', get_template_directory_uri() . '/css/tools.css');
	wp_enqueue_style( 'phone', get_template_directory_uri() . '/css/phone.css');
...
function register_my_menus() {
  register_nav_menus(
    array(
      ...
      'second-menu' => __( 'RisicovolSpelen' ),
      'tool-menu' => __( 'Toolbox' ),
      'media-menu' => __( 'Media' ),
...
// Register Custom Post Type
function custom_post_type_meerwaarde() {
...
add_action( 'init', 'custom_post_type_meerwaarde', 0 );

// Register Custom Post Type
function custom_post_type_vormen() {

	$labels = array(
		'name'                  => _x( 'Vormen', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Vormen', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Vormen', 'text_domain' ),
		'name_admin_bar'        => __( 'Vormen', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
	...
	register_post_type( 'Vormen', $args );
}
add_action( 'init', 'custom_post_type_vormen', 0 );


// Register Custom Post Type
function custom_post_type_tools() {

	$labels = array(
		'name'                  => _x( 'Tools', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Tools', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Tools', 'text_domain' ),
		'name_admin_bar'        => __( 'Tools', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
...
add_action( 'init', 'custom_post_type_tools', 0 );
...
// Register Custom Post Type
function custom_post_type_audiodoc() {
...
add_action( 'init', 'custom_post_type_audiodoc', 0 );
...
function mytheme_widgets_init() {
    register_sidebar( array(
        'name'          => __( 'News Widget', 'textdomain' ),
        'id'            => 'news',
