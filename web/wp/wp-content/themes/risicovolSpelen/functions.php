...
function add_theme_scripts() {   
	...
	wp_enqueue_style( 'beheerders', get_template_directory_uri() . '/css/beheerders.css');
...
// Register Custom Post Type
function custom_post_type_artikels() {

	$labels = array(
		'name'                  => _x( 'Artikels', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Artikels', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Artikels', 'text_domain' ),
		'name_admin_bar'        => __( 'Artikels', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
	...
	register_post_type( 'Artikels', $args );

}
add_action( 'init', 'custom_post_type_artikels', 0 );
